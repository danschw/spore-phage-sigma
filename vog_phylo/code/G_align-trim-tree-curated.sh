...
##### Define paths #####
PARENT=~/GitHub/spore-phage-sigma/vog_phylo
ODIR=${PARENT}/data/curated_set_to_align
mkdir -p ${ODIR}
...
sbatch ${PARENT}/code/G1_batch-IQ-curated.sh
#-------------------
# Best-fit model: LG+G4 chosen according to BIC

# got a warning:
# Number of parameters (K, model parameters and branch lengths): 112
# Sample size (n, alignment length): 84
# This is much better
...
sbatch ${PARENT}/code/G2_multi-run-iqtree-curated.sh 

#Use best lh tree  
sbatch ${PARENT}/code/G3_batch-IQ-curated-support.sh
